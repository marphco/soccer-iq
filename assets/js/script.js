...
let answerCheckEl = $('#answer-check')
...
// function generating HTML buttons for the answers at the questions
...
// Correct answer function to show a feedback to the user
function correctAnswer () {
  answerCheckEl.append(`Goooooooal! ✅ Score: ${score}`)
  setTimeout(function () {
    answerCheckEl.empty(); // Remove the correct answer message after 1 second
  }, 1000);
}

// Wrong answer function to show a feedback to the user
function wrongAnswer () {
  answerCheckEl.append("You missed it! ❌ -10 seconds")
  setTimeout(function () {
    answerCheckEl.empty(); // Remove the wrong answer message after 1 second
  }, 1000);
}
